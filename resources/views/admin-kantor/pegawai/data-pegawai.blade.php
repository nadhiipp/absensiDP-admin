...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-5 flex justify-between items-start">
        <div>
            <p class="text-sm text-slate-500 mb-2">Tidak Aktif</p>
    ...
    <div class="overflow-x-auto">
        <table class="w-full">
            ...
            <tbody class="divide-y divide-slate-100">
                @php
                    $pegawai = [
                        ['nip' => 'PB001', 'nama' => 'Budi Santoso', 'dept' => 'Produksi', 'jabatan' => 'Operator Mesin','tgl_masuk' => '15 Jan 2020', 'status' => 'Aktif'],
                        ['nip' => 'PB002', 'nama' => 'Siti Aminah', 'dept' => 'Quality Control', 'jabatan' => 'QC Inspector',  'tgl_masuk' => '20 Mar 2021', 'status' => 'Aktif'],
                        ['nip' => 'PB003', 'nama' => 'Ahmad Wijaya', 'dept' => 'Warehouse', 'jabatan' => 'Store Keeper', 'tgl_masuk' => '10 Mei 2019', 'status' => 'Aktif'],
                        ['nip' => 'PB004', 'nama' => 'Dewi Lestari', 'dept' => 'HRD', 'jabatan' => 'HR Staff', 'tgl_masuk' => '05 Ags 2022', 'status' => 'Aktif'],
                        ['nip' => 'PB005', 'nama' => 'Rizki Pratama', 'dept' => 'Maintenance', 'jabatan' => 'Teknisi', 'tgl_masuk' => '30 Nov 2020', 'status' => 'Aktif'],
                        ['nip' => 'PB006', 'nama' => 'Lina Marlina', 'dept' => 'Produksi', 'jabatan' => 'Supervisor', 'tgl_masuk' => '12 Feb 2018', 'status' => 'Aktif'],
                        ['nip' => 'PB007', 'nama' => 'Eko Saputra', 'dept' => 'Quality Control', 'jabatan' => 'QC Supervisor', 'tgl_masuk' => '18 Jun 2019', 'status' => 'Aktif'],
                        ['nip' => 'PB008', 'nama' => 'Rina Wati', 'dept' => 'Warehouse', 'jabatan' => 'Admin Gudang', 'tgl_masuk' => '25 Sep 2021', 'status' => 'Aktif'],
                        ['nip' => 'PB009', 'nama' => 'Hadi Kusuma', 'dept' => 'Produksi', 'jabatan' => 'Operator Mesin', 'tgl_masuk' => '14 Apr 2022', 'status' => 'Cuti'],
                        ['nip' => 'PB010', 'nama' => 'Maya Sari', 'dept' => 'HRD', 'jabatan' => 'HR Manager', 'tgl_masuk' => '03 Jan 2017', 'status' => 'Aktif'],
                    ];
                @endphp
...
@include('admin-kantor.pegawai.create')
@include('admin-kantor.pegawai.edit')
@include('admin-kantor.pegawai.delete')
@endsection