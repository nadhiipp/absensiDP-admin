...
@section('title', 'Data Pegawai - Absensi Pabrik')

@section('content')
<!-- Page Header -->
<div class="mb-6">
    <h1 class="text-2xl font-semibold text-slate-800">Data Pegawai</h1>
    <p class="text-sm text-slate-500 mt-1">Manajemen data seluruh pegawai pabrik</p>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
    <div class="bg-white border border-slate-200 rounded-xl p-5 flex justify-between items-start">
        <div>
            ...
            <p class="text-xs font-medium text-emerald-500">+5% dari bulan lalu</p>
        </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-5 flex justify-between items-start">
        <div>
            ...
            <p class="text-xs font-medium text-emerald-500">98% aktif</p>
        </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-5 flex justify-between items-start">
        <div>
            ...
            <p class="text-xs font-medium text-emerald-500">Bulan Des 2025</p>
        </div>
        <div class="w-11 h-11 bg-emerald-100 rounded-xl flex items-center justify-center text-emerald-500">
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover: bg-slate-50 transition-all">
                    ...
                    <td class="px-5 py-4">
                        <button class="text-sm text-emerald-600 hover:text-emerald-700 font-medium">Edit</button>
                    </td>
                </tr>
                @endforeach
            </tbody>
