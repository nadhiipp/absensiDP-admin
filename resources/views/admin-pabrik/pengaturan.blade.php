...
@section('title', 'Pengaturan Sistem - Absensi Pabrik')

@section('content')
<!-- Page Header -->
<div class="mb-6">
    <h1 class="text-2xl font-semibold text-slate-800">Pengaturan Sistem</h1>
    <p class="text-sm text-slate-500 mt-1">Konfigurasi dan pengaturan sistem absensi pabrik</p>
</div>
    ...
    <div class="divide-y divide-slate-100">
        <div class="px-6 py-4 flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-0.5">PT Pabrik Indonesia Jaya</p>
            </div>
            <button class="text-sm text-slate-500 hover: text-emerald-600 font-medium">Ubah</button>
        </div>
        <div class="px-6 py-4 flex justify-between items-center">
            <div>
                <h4 class="text-sm font-medium text-slate-800">Alamat Pabrik</h4>
        ...
        <div class="px-6 py-4 flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-0.5">info@pabrikindonesia.com</p>
            </div>
            <button class="text-sm text-slate-500 hover: text-emerald-600 font-medium">Ubah</button>
        </div>
    </div>
...
<div class="bg-white border border-slate-200 rounded-xl mb-6">
    ...
    <div class="divide-y divide-slate-100">
        ...
        <div class="px-6 py-4 flex justify-between items-center">
            ...
            <button class="text-sm text-slate-500 hover:text-emerald-600 font-medium">Kelola</button>
        </div>
    </div>
</div>
...
<div class="bg-white border border-slate-200 rounded-xl mb-6">
    ...
    <div class="divide-y divide-slate-100">
        <div class="px-6 py-4 flex justify-between items-center">
            ...
            <button class="text-sm text-slate-500 hover:text-emerald-600 font-medium">Kelola Shift</button>
        </div>
        <div class="px-6 py-4 flex justify-between items-center">
            <div>
        ...
        <div class="px-6 py-4 flex justify-between items-center">
            ...
            <button class="px-4 py-1. 5 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg text-sm font-medium transition-all">
                Aktifkan
            </button>
        </div>
    </div>
